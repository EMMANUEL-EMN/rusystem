...
@section('title', 'deferment application')

@section('content')
    <div class="instructons">
        <h4 class="text-center">DEFERMENT APPLICATION</h4>
        <hr>
        <h5>INSTRUCTIONS</h5>
        <ol>
            <li>
    ...
    <div class="info">
        <h4 class="text-center">REASONS FOR DEFERMENT</h4>
        <hr>
        <p>
